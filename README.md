...
# Режим відкриття файлу для логування. Можливі значення: a (append - додавання до файлу) або w (write - перезапис файлу)
filemode = a

# Формат запису логів. Використовуйте стандартні формати бібліотеки logging
format = %(asctime)s,%(msecs)d %(name)s %(levelname)s %(message)s

# Формат дати та часу для запису в логах. Використовуйте стандартні формати бібліотеки logging
dateformat = %H:%M:%S

# Рівень логування. Можливі значення: DEBUG, INFO, WARNING, ERROR, CRITICAL
level = DEBUG
```
