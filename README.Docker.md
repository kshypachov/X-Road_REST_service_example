# Посібник з роботи з Docker

## Опис

Ця інструкція описуе процесс запуску прикладу сервіса у оточені Docker. База даних вже повинна бути створена. Для створення структури бази даних, заватнажте дамп бд на розгорніть на сервері MariaDB 10.5+
