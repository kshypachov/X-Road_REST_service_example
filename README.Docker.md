# Посібник з роботи з Docker для FastAPI додатку

## Опис

Це додаток, побудований на **FastAPI**, який працює з базою даних через SQLAlchemy та підтримує роботу в Docker. Додаток дозволяє керувати даними про людей через REST API та налаштований на гнучку роботу з змінними оточення та конфігураційними файлами.
